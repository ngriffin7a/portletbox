...
public class TestPortlet extends GenericPortlet {
	...
	public void processAction(ActionRequest actionRequest, ActionResponse actionResponse) throws PortletException,
		...
		try {
			...
			actionResponse.setRenderParameter("publicRenderParameter1Error",
				"Error trying to remove privateRenderParameter1: " + e.getMessage());
			e.printStackTrace();
		}
		...
		try {
			...
			actionResponse.setRenderParameter("privateRenderParameter1Error",
				"Error trying to remove privateRenderParameter1: " + e.getMessage());
			e.printStackTrace();
		}
	...
	protected void doView(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException,
		...
		String publicRenderParameter1Error = renderRequest.getParameter("publicRenderParameter1Error");

		if (publicRenderParameter1Error != null) {
			writer.write("<span class=\"portlet-msg-error\">" + publicRenderParameter1Error + "</span>");
			writer.write(HTMLUtil.HR_TAG);
		}

		String privateRenderParameter1Error = renderRequest.getParameter("privateRenderParameter1Error");

		if (privateRenderParameter1Error != null) {
			writer.write("<span class=\"portlet-msg-error\">" + privateRenderParameter1Error + "</span>");
			writer.write(HTMLUtil.HR_TAG);
		}
